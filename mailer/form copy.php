...
<form id="cf" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
    ...
    <div class="form-floating mb-3">
        <input type="text" class="form-control" id="user_name" name="user_name" value="" placeholder="" onkeypress="return (event.charCode == 32 || event.charCode == 209 || event.charCode == 241 || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122))">
        <label for="user_name"><i class="bi bi-person-circle"></i> Tu nombre...</label>
    </div>

    <div class="form-floating mb-3">
        <input type="email" class="form-control" id="user_email" name="user_email" value="" placeholder="">
        <label for="user_email"><i class="bi bi-envelope-at"></i> Tu email...</label>
    </div>

    <div class="form-floating mb-3">
        <input type="text" class="form-control" id="user_tel" name="user_tel" value="" placeholder="" minlength="5" maxlength="15" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57))">
        <label for="user_tel"><i class="bi bi-telephone"></i> Teléfono de contacto</label>
    </div>
    <p class="tiny" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-question-circle"></i> Cómo ingresar tu número</p>
    <div class="spacer"></div>
    <div class="form-floating">
        <textarea class="form-control" placeholder="" id="user_mje" name="user_mje"><?php //echo 'value';
                                                                                    ?></textarea>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p><b>Código regional</b> + número, sin 15, sin espacios ni guiones. Ej:<span style="color: green;"> <b>261</b>4123456</span></p>
